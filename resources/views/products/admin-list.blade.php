...
@section('content')
    <div class="content-card">
        <h2><i class="fas fa-box"></i> Imported Products</h2>
        <p>View all products imported by all users.</p>
                        ...
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small style="color: #999;">{{ $product->user->email }}</small>
                                </td>
        ...
        @else
            <div class="alert alert-info" role="alert">
                <i class="fas fa-info-circle"></i> No products have been imported yet.
            </div>
        @endif
    </div>
    ...
    <script>
        ...
        async function loadProductDetails(productId) {
            try {
                ...
                if (data.success) {
                    renderProductDetails(data.product, data.user);
                } else {
        ...
        function renderProductDetails(product, user) {
            const details = `
                <div class="product-detail-row">
                    <div class="product-detail-label">User:</div>
